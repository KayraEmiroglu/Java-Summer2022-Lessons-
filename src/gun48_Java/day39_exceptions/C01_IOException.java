...
public class C01_IOException {
    public static void main(String[] args) throws FileNotFoundException {
        /*
         ...
         FileOutputStream Class'indan yardım aliriz
         */
        ...
        /*
         ...
         Compile Time Exception olustugunda Java cozum icin 2 ihtimal
         onerir.
         1- try-catch ile cevrelemek
         2- method signature'ina throws keyword ile bekelenen exception
         turunu yazmak.
         ...
         Ancak throws Exception yazdigimizda Java bir exception ile
